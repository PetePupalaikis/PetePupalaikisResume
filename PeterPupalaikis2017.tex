...
\vspace{-1em}\subsection*{\Large Patents}\vspace{-0.5em}
	\parskip=0.1em
\begin{flushleft} 
	43 US Patents with many matching foreign patents issued in the area of measurement instrument
	design.
	
	Key inventor including continuations and continuations-in-part for a key technology
	called Digital Bandwidth Interleaving (DBI), a microwave/DSP technology.  This technology has
	enabled LeCroy to produce industry-leading bandwidth oscilloscopes including the latest
	record of 100 GHz, 240 GS/s digitizer channels.
\end{flushleft}
\headerrow
